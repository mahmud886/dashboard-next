          ...
          <NavigationMenuList>
            ...
            <NavigationMenuItem>
              <Link href='/live-tv' legacyBehavior passHref>
                <NavigationMenuLink className={navigationMenuTriggerStyle()}>Live Tv</NavigationMenuLink>
              </Link>
            </NavigationMenuItem>
            <NavigationMenuItem>
              <Link href='/my-list' legacyBehavior passHref>
                <NavigationMenuLink className={navigationMenuTriggerStyle()}>My List</NavigationMenuLink>
              </Link>
            </NavigationMenuItem>
            <NavigationMenuItem>
              <Link href='/movie-request' legacyBehavior passHref>
                <NavigationMenuLink className={navigationMenuTriggerStyle()}>Request</NavigationMenuLink>
              </Link>
            </NavigationMenuItem>
          </NavigationMenuList>
        </NavigationMenu>
              ...
              <DrawerHeader>
                ...
                <DrawerDescription>
                  <div className='sidebar-navlist'>
                    <Link href='/profile' className='block rounded-none border-b-2 border-[#909090]'>
                      <label
                    ...
                    <Link href='/parental-lock' className='block rounded-none border-b-2 border-[#909090]'>
                      <label
                        htmlFor='User Profile'
                        aria-label='close sidebar'
                        className='flex items-center justify-between px-4 py-4 cursor-pointer text-black dark:text-white font-medium text-[16px]'>
                        <div className='flex items-center hover:text-[#E83431]'>
                          ...
                          <span className='pl-2'>Parental Pin lock</span>
                        </div>
                        <div>
                          <svg
                            width='15'
                    ...
                    <Link href='/parental-lock' className='block rounded-none border-b-2 border-[#909090]'>
                      <label
                        ...
                        <div className='flex items-center hover:text-[#E83431]'>
                          ...
                          <span className='pl-2'>My Watchlist</span>
                        </div>
                        <div>
                          <svg
                            width='15'
                    ...
                    <Link href='/parental-lock' className='block rounded-none border-b-2 border-[#909090]'>
                      <label
                        ...
                        <div className='flex items-center hover:text-[#E83431]'>
                          ...
                          <span className='pl-2'>Enable Light Mode</span>
                        </div>
                        <div>
                          <svg
                            width='15'
