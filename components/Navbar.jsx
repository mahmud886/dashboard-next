          ...
          <NavigationMenuList>
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                ...
                <ul className="grid w-[400px] gap-4 p-6 md:w-[600px] md:grid-cols-4 lg:w-[600px]">
                  {movieCategories.map((category, index) => (
                      <li key={index}
                          className="transition ease-in-out py-1 px-2 rounded-[5px] hover:text-[#E83431] hover:scale-105 hover:font-semibold duration-300">
                        <Link href={`/${category}`} className="text-black dark:text-white">
                          {category}
                        </Link>
                      </li>
                  ))}
