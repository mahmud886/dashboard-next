...
const TermsConditionBottom = () => {
  return (
    <section className="terms-condition-area">
        <div className="container pt-0 md:pt-[60px]">
            <h3
                className="font-bold font-archivo text-[22px] md:text-[36px] py-[10px] md:py-[20px] border-b-2 border-[#D7D7D7] mb-[20px]">
                Terms & Condition!
            </h3>
        </div>
        <div className="terms-condition-content container">
            ...
            <p className='text-[15px] font-archivo font-light pt-4 pb-16'>If you have any questions or concerns about this terms and condition, please contact us to: <br/> support@TSports.com </p>
        </div>
    </section>
  )
}

export default TermsConditionBottom