...
const MoreNewsCard = ({title, shortDescription, imgUrl, time}) => {
  return (
          <div className='group grid grid-cols-12 gap-8 items-center py-[40px] border-b-2 border-tsGrey hover:cursor-pointer'>
            <div className='col-span-8'>
              <div>
                <h2 className="mb-2 text-[24px] font-bengali2 font-bold tracking-tight transition-all ease-in-out duration-300 group-hover:text-tsRed">{title}</h2>
                <p
                  className='mt-4 mb-3 text-[16px] font-bengali2 font-normal text-tsLightGrey line-clamp-4 transition-all ease-in-out duration-300 group-hover:text-tsBlack'>শ{shortDescription}</p>
                <p className='flex gap-2 items-center font-bengali2 text-[16px] text-tsLightGrey transition-all ease-in-out duration-300 group-hover:text-tsBlack'>
                  <span>
                    <svg width="10" height="9" viewBox="0 0 10 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        ...
                        fill="#808080"/>
                      <path d="M6.08083 6.42857L4.28404 4.63179V1.60714H4.9269V4.365L6.53404 5.97536L6.08083 6.42857Z"
                            fill="#808080"/>
                    </svg>
                  </span>{time}
                </p>
